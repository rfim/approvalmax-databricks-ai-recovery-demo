...
The 'databricks_ai' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/databricks_ai/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] databricks_ai_etl` to your workspace.
...
5. Finally, to run tests locally, use `pytest`:
   ...
   $ uv run pytest
   ```
# approvalmax-databricks-ai-recovery-demo
